...
topoi$topic <- NULL
topoi
ifelse(concept == 'school', beta_list <- dplyr::filter(topoi, grepl("school|college|cse|c.s.e|h.n.d.|h.n.c.|o.n.d.|training|naval college|career|equivalent|leave|leaving|level*|university|exam|course|guilds|qualifications|grade|sheppey|comprehensive", term)),
...
ifelse(concept == 'family', beta_list <- dplyr::filter(topoi, grepl("wife|year|marriage|marry|companion|married|remarry|remarried|child|children|husband|son|daughter|family|girl|boy|kid|mother|divorce|baby|babies|father|grandfather|grandmother|grandparent|grandparents|her|she|family", term)),
...
dic <- quanteda::dictionary(list(school = c('school','college','cse','c.s.e', 'h.n.d.','h.n.c.','o.n.d.','training','naval college','career', 'equivalent','level','levels','university','exam','exams','levels','course',  'guilds','qualifications','grade','sheppey','comprehensive'),
...
family = c('wife','companion','year','marry','married','child','husband','marriage','house','son','daughter','famil','girl','boy','kid','mother','remarry','remarried','divorce','baby','babies','housewife','father','grandfather','grandmother','divorced','grandparent','her','she','family')))
